...
class _Done_tasksState extends State<Done_tasks> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<CubitTodo , todoStates>(
      ...
      {return
        ListView.separated(
          itemBuilder: (context, index) => def_task(Cubit.DoneTasks,index),
          ...
          child: Row(
            children: [
              ...
              IconButton(onPressed: (){
                Cubit.updateData(Cubit.DoneTasks[index]['Id'],'Done');
              ...
              IconButton(onPressed: (){
                Cubit.updateData(Cubit.DoneTasks[index]['Id'],'Archived');
                // print (Cubit.tasks[index]['Id']);
